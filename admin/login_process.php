...
// Buscar db_config.php en la raíz del proyecto o en el directorio actual
    ...
    try {
        ...
        if ($user) {
            ...
            if (password_verify($contrasena_ingresada, $user['contrasena_usuario'])) {
                ...
                // Si estaba en texto plano, re-encriptar a Bcrypt automáticamente
                $password_correcta = true;
            ...
            if ($password_correcta) {
                // Guardar las variables de sesión exactas que usan tus vistas
