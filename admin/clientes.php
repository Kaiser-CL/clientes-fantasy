...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($pdo)) {
    // Procesa la creación de un nuevo cliente con rol de usuario.
    ...
    // Procesa la actualización de datos y estado del cliente.
    ...
    if (isset($_POST['accion']) && $_POST['accion'] === 'eliminar') {
        ...
        if ($id_usuario_eliminar) {
            // Permisos: solo SuperAdmin o Admin pueden eliminar clientes
            if (!(esSuperAdmin() || (function_exists('esAdmin') && esAdmin()))) {
                $_SESSION['error_db'] = "No tienes permisos para eliminar clientes.";
                header("Location: clientes.php");
                exit;
            }
            try {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST">
                ...
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title fw-bold">Registrar un nuevo cliente</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
