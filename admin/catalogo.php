...
// Procesa las acciones de creación, edición y eliminación del catálogo.
...
// Consulta el catálogo y cuenta los archivos asociados a cada registro.
$servicios_lista = [];
if (isset($pdo)) {
    try {
            ...
            <form action="catalogo.php" method="POST" id="form-servicio">
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label">¿Para qué tipo de evento?</label>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">¿Dónde se ofrece?</label>
                        ...
                        <div class="col-md-8">
                            <label class="form-label">Nombre del paquete/servicio</label>
                            <input type="text" name="nombre_servicio" id="nombre_servicio" class="form-control" placeholder="Ej: Carrito de Snacks, Paquete Básico Infantil..." required maxlength="80" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" title="Solo letras y espacios">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Precio ($)</label>
                            <input type="number" step="0.01" min="0" max="999999.99" name="precio_servicio" id="precio_servicio" class="form-control" placeholder="0.00" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label">¿Qué incluye? (Descripción)</label>
                            <textarea name="descripcion_servicio" id="descripcion_servicio" class="form-control" rows="3" maxlength="500" placeholder="Cuéntales qué incluye este paquete..."></textarea>
                            <small id="contador_descripcion_servicio" class="form-text text-muted">0/500</small>
                        </div>
                        <div class="col-md-6 d-flex align-items-center mt-4">
                            <div class="form-check form-switch fs-6">
                                <input class="form-check-input" type="checkbox" name="es_por_persona" id="es_por_persona" value="1">
                                <label class="form-check-label fw-bold text-dark" for="es_por_persona">¿Se cobra por persona?</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-check form-switch fs-6">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let campoDescripcion = document.getElementById('descripcion_servicio');
    let contadorDescripcion = document.getElementById('contador_descripcion_servicio');

    if (campoDescripcion && contadorDescripcion) {
        const actualizarContadorDescripcion = () => {
            const restante = 500 - campoDescripcion.value.length;
            contadorDescripcion.textContent = `${campoDescripcion.value.length}/500`;
            contadorDescripcion.className = restante < 0 ? 'form-text text-danger' : 'form-text text-muted';
        };

        campoDescripcion.addEventListener('input', actualizarContadorDescripcion);
