                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-7">
                        <div class="card shadow-sm border-0 p-4 rounded-3 bg-white mb-4">
                            ...
                            <div class="mb-3">
                                <label class="form-label text-success fw-bold">Selecciona o registra un cliente</label>
                                <select name="id_cliente_existente" id="id_cliente_existente" class="form-select" onchange="evaluarClienteExistente()">
                            ...
                            <div id="seccion-cliente-nuevo">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="apellidos_cliente" name="apellidos_cliente" class="form-control" placeholder="Ej: García Sánchez" maxlength="80" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" title="Solo letras y espacios">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" id="telefono_cliente" name="telefono_cliente" class="form-control" placeholder="5535245423" maxlength="10" minlength="10" pattern="[0-9]{10}" inputmode="numeric" title="10 dígitos">
                                    </div>
                                </div>
                                <div class="alert alert-info py-2 px-3 mt-3 mb-0 fs-6">
                                    <i class="fa-solid fa-key me-1"></i> <strong>La contraseña asignada automaticamente</strong> fantasy2026
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="card shadow-sm border-0 p-4 rounded-3 bg-white">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Elige un paquete</label>
                                <select name="id_paquete_base" id="select_paquete_base" class="form-select" onchange="actualizarCalculosEventos()" required>
                                    <option value="" data-precio="0" data-ubicacion="ambos">Paquete...</option>
                ...
                <div class="mb-3">
                    ...
                    <select id="modal_select_extra" class="form-select" onchange="evaluarModalExtraPrecio()">
                        ...
                        <?php foreach ($extras_catalogo as $ext): 
                            ...
                            $ubi_ext = strtolower($ext['ubicacion'] ?? 'ambos');
                        ?>
...
function filtrarPorUbicacion() {
    ...
    let selectExtra = document.getElementById('modal_select_extra');
    if (selectExtra) {
        Array.from(selectExtra.options).forEach(opt => {
            let ubi = opt.getAttribute('data-ubicacion') || 'ambos';
            if (opt.value === '') return;
        ...
        if (selectExtra.value && Array.from(selectExtra.options).every(opt => opt.value !== selectExtra.value || opt.style.display === 'none')) {
            selectExtra.value = '';
