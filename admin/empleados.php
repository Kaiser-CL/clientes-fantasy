...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($pdo)) {
    ...
    // Procesa la actualización de datos del empleado.
                                                    ...
                                                    <form method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="nombre_usuario" class="form-control" value="<?= htmlspecialchars($emp['nombre_usuario']) ?>" required maxlength="80" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" title="Solo letras y espacios">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label fw-bold">Apellidos</label>
                                                                <input type="text" name="apellidos_usuario" class="form-control" value="<?= htmlspecialchars($emp['apellidos_usuario']) ?>" required maxlength="80" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" title="Solo letras y espacios">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label fw-bold">Correo Electrónico</label>
                                                                <input type="email" name="correo_usuario" class="form-control" value="<?= htmlspecialchars($emp['email'] ?? '') ?>" required maxlength="100" autocomplete="email">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label fw-bold">Teléfono</label>
                                                                <input type="tel" name="telefono_usuario" class="form-control" value="<?= htmlspecialchars($emp['telefono_usuario'] ?? '') ?>" maxlength="10" minlength="10" pattern="[0-9]{10}" inputmode="numeric" title="Ingresa 10 dígitos numéricos">
                                                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST">
                ...
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title fw-bold">Registrar un nuevo empleado</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nombre</label>
                        <input type="text" name="nombre_usuario" class="form-control" required maxlength="80" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" title="Solo letras y espacios">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Apellidos</label>
                        <input type="text" name="apellidos_usuario" class="form-control" required maxlength="80" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" title="Solo letras y espacios">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Correo Electrónico</label>
                        <input type="email" name="correo_usuario" class="form-control" required maxlength="100" autocomplete="email">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Teléfono</label>
                        <input type="tel" name="telefono_usuario" class="form-control" maxlength="10" minlength="10" pattern="[0-9]{10}" inputmode="numeric" title="Ingresa 10 dígitos numéricos">
                    </div>
                    <div class="mb-3">
